# Legacy FastGraph Plotting Repository

This repository preserves the plotting workspace used by the original
`pca-fgc-paper-v1.0.1` audit release. Its contents now live under
`archive/legacy/` so the historical revision remains inspectable.
...
stable historical links and prior-release reproduction.
